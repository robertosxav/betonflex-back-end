...
import com.betonflex.exceptions.vo.DetalhesErro;


@ControllerAdvice
public class BetonflexExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(RuntimeException ex, WebRequest request) {
		...
		String mensagemUsuario = BetonflexExceptionMensagem.RECURSO_NAO_ENCONTRADO;
	...
	public ResponseEntity<Object> handleEmptyResultSuchMessageException(NoSuchMessageException ex, WebRequest request) {
		...
		// Carrega os dados do erro
		String mensagemUsuario = BetonflexExceptionMensagem.ARQUIVO_MENSAGEM_NAO_ENCONTRADO;
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex,
		...
		String mensagemUsuario = BetonflexExceptionMensagem.RECURSO_VIOLACAO_CHAVE;
	...
	@ExceptionHandler({ BetonflexException.class })
