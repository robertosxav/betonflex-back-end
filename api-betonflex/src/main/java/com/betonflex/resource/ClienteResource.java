...
public class ClienteResource {
	...
	public ResponseEntity<String> adicionarOrdensServicos(@PathVariable Long codigo,
			@RequestBody List<OrdemServico> listaOrdensServico) {
	...
	// @ApiOperation(value = "Pesquisar clientes passando um parametro de busca,
	// resposta paginada")
	...
	// @ApiOperation(value = "Pesquisar todos clientes ativos")
	@GetMapping("/ativos")
	public List<Cliente> listarTodosAtivos() {
		return clienteService.listarTodosAtivos();
	}

	// @ApiOperation(value = "Pesquisar todos clientes ativos, resposta paginada")
	@GetMapping("/ativos/paginado")
	public Page<Cliente> listarTodosAtivo(Pageable pageable) {
		return clienteService.listarTodosAtivos(pageable);
	}
